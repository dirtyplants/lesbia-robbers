...
Here, we report the occurrence of nectar larceny in the two currently recognized species of trainbearers and analyze the proportion of plant visits categorized by mode of visitation as: robbing, theft, and/or pollination. 
We augment our original field observations using a trove of data from citizen science databases.
...
Our results also indicate that the relationship between serration of bill tomia and traits such as nectar robbing or territorial defense may be more complicated than suggested in the literature.
We discuss the significance of our findings in the context of recent developments in the study of nectar foraging, larceny, and pollination from both avian and plant perspectives.
\end{abstract}
...
\subsubsection*{Description of original observation} % added to clarify descriptive data
...
We collected and examined more than 1550 photographs of \textit{Lesbia} and found floral visits for 180 foraging bouts (Figure \ref{fig:fig1}, and Supplementary Data Table) on at least 42 flowering plant genera, identified thus far. %FIXME (re-count and fix "42" after identifying all plants; also photograph number and foraging bouts).
...
In each of these plant-side studies, however, the proportion of hummingbirds' visits comprised of each visit mode is unknown, and in some cases the primary robber is not a hummingbird. %B: These additions are largely satisfying Reviewer 1 requests, not clear that this is useful.
...
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth]{fig1/marauding_lesbias_fig_1c.pdf}
