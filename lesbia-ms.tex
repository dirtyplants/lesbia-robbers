...
\caption{Anterior side of the bill of a male \textit{Lesbia nuna}, FMNH-222250, with no visible serations on its mandibular (or maxillary) tomia. Background scale is denoted in mm distance units.}
\label{figure:figS2}
\end{center}
\end{suppfigure}
